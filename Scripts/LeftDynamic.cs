...
public class LeftDynamic : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Role.GetComponent<BipedIK>().solvers.leftHand.bone3.transform = FakeHand.transform;
    ...
    public void SetDynamicState(Text initcode)
    {
        ...
        if (code == "W1")
        {
            ...
            RealHand.transform.localEulerAngles = new Vector3(0f, 0f, 0f);
            Role.GetComponent<BipedIK>().solvers.leftHand.bone3.transform = FakeHand.transform;
            Role.GetComponent<BipedIK>().solvers.leftHand.target = RealTarget.transform;
            RealHand.transform.localEulerAngles = new Vector3(0f, 0f, 0f);
        }
        else if (code == "W2")
        {
        ...
        else if (code == "C1")
        {
            ...
            RealHand.transform.localEulerAngles = new Vector3(0f, 0f, 0f);
            Role.GetComponent<BipedIK>().solvers.leftHand.bone3.transform = FakeHand.transform;
            Role.GetComponent<BipedIK>().solvers.leftHand.target = CircleTarget.transform;
            RealHand.transform.localEulerAngles = new Vector3(0f, 0f, 0f);
            CircleRotate.transform.localEulerAngles = new Vector3(0, 0, 0);
        }
        else if (code == "C2")
